module RightSignature
  module Document
    ...
    def documents_batch_details(guids)
      get "/documents/#{guids.join(',')}/batch_details"
    end
    ...
    def send_reminder(guid)
      post "/documents/#{guid}/send_reminders", {}
    end
    ...
    def extend_document_expiration(guid)
      post "/documents/#{guid}/extend_expiration", {}
    end
    ...
    def update_document_tags(guid, tags)
      post "/documents/#{guid}/update_tags", { :tags => TagsHelper.array_to_xml_hash(tags) }
    end
    ...
    def get_document_signer_links_for(guid, redirect_location = nil)
      ...
      response = get "/documents/#{guid}/signer_links", params
